...
We include the ablation-suite plots generated by the runner in `runs/ablations/plots`. Each plot aggregates three seeds using the protocol in Section 6.0. TokenMerge in A4 corresponds to the MiniCache-style depth merge configuration.
